...
class User(db.Model, SerializerMixin):
    ...
    serialize_rules = ('-listings.owner', '-bookmarks.user', '-_password_hash')
...
class Listing(db.Model, SerializerMixin):
    ...
    serialize_rules = ('-owner.listings', '-bookmarks.listing')
...
class Bookmark(db.Model, SerializerMixin):
    ...
    serialize_rules = ('-user.bookmarks', '-listing.bookmarks')
